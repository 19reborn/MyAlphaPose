...
parser.add_argument('--posebatch', type=int, default=5,
...
parser.add_argument('--hand-face',action='store_true')
...
if __name__ == "__main__":
    ...
    if args.save_video and mode != 'image':
        ...
        writer = DataWriter(cfg, args, save_video=False, queueSize=queueSize, view = args.view,  hand_face = args.hand_face).start()
