...
class DataWriter():
    def __init__(self, cfg, opt, view, hand_face = False, save_video=False,
    ...
    def update(self):
        ...
        while True:
            ...
            if orig_img is None:
                ...
                if self.save_video:
                    stream.release()
                write_json(final_result, self.opt.outputpath, form=self.opt.format, for_eval=self.opt.eval, view = self.view, hand_face = self.hand_face)
